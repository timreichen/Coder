...
export const fixedObjectDataType = (length: number) => ({
  test(data: any) { return getType(data) === "Object" && Object.keys(data).length === length },
  encode(encoder: Encoder, data: any) {
    return Object.entries(data).reduce((buffer: any, [key, value]: any) => encoder.combineBuffers(buffer, encoder.encode(key), encoder.encode(value)), new ArrayBuffer(0))
  },
...
export const Object8DataType = {
  test(data: any) { return getType(data) === "Object" && Object.keys(data).length <= UINT_8_MAX_VALUE },
  encode(encoder: Encoder, data: any) {
...
export const Object16DataType = {
  test(data: any) { return getType(data) === "Object" && Object.keys(data).length <= UINT_16_MAX_VALUE },
  encode(encoder: Encoder, data: any) {
    const length = Object.keys(data).length
...
export const Object32DataType = {
  test(data: any) { return getType(data) === "Object" && Object.keys(data).length <= UINT_32_MAX_VALUE },
  encode(encoder: Encoder, data: any) {
    const length = Object.keys(data).length
